...
from MicLBM_src.run_mictherm import run_mictherm_func, mictherm_grid
            ...
            with open(validation_results_path, "a", newline="", encoding="utf-8") as file:
                ...
                writer.writerow(
                    [
                        ...
                        float(rho_g), # Maxwell construction
                        float(rho_g_pred), #simulation result
                        float(rho_l), # Maxwell construction
                        float(rho_l_pred), #simulation result
                    ]
                )
